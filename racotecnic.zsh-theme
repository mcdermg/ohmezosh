...
# primary prompt
#GMcD altered below to remove dashes with spaces instead to stilll break up lines on cmd prompt but dashes were annoting me
...
RPROMPT='$rt_gray%n@%m%   %T%{$reset_color%}%'
#Added by GMcD to add datetimestring to rprompt
#RPROMPT='%D{%y/%m/%f} %@'
#RPROMPT='$rt_gray%T%{$reset_color%}%'
